            ...
            modelBuilder.Entity("TravelAgency_MVC.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            airline = "Airline1",
                            capacity = 150,
                            date = new DateTime(2024, 1, 15, 19, 49, 51, 442, DateTimeKind.Local).AddTicks(5212),
                            destinationId = 2,
                            flightPrice = 300.0,
                            originId = 1,
                            soldFlights = 50
                        ...
                        new
                        {
                            ...
                            airline = "Airline2",
                            capacity = 120,
                            date = new DateTime(2024, 1, 30, 19, 49, 51, 442, DateTimeKind.Local).AddTicks(5228),
                            destinationId = 1,
                            flightPrice = 250.0,
                            originId = 2,
                            soldFlights = 30
